...
%   lowAmpSpikeThreshold: maximum percent (eg 30) of estimated spikes below detection
...
for iUnit = 1:length(unitType)
    ...
    % disregard chunks with missing spikes > lowAmpSpikeThreshold
    valid(cutOffs > param.lowAmpSpikeThreshold) = false;
